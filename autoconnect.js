...
Linkedin = {
    ...
    config: {
        ...
        note: "Buongiorno {{name}}, abbiamo una soluzione per facilitare la raccolta dati e la creazione del report ESG. Si tratta di un tema di interesse? Grazie, Valerio" // Default note template
    },
    ...
    // Function to click "Send" button in the invitation popup
